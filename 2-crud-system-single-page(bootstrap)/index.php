...
<html lang="en">
    <head>
        ...
        <title>crud-single-bootstrap</title>
        <link href="theme/css/simple-datatables-style.min.css" rel="stylesheet" />
        <link href="theme/css/styles.css" rel="stylesheet" />
        <script src="theme/css/fonticons-all.js" crossorigin="anonymous"></script>
    </head>
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">CRUD-SINGLE-v1.0</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="container-fluid px-4">
                        <div class="card my-4">
                            <div class="card-header">
                                ...
                                <!-- Model Add Button -->
                                <button type="button" class="btn btn-primary py-0 float-end" data-bs-toggle="modal" data-bs-target="#addContact">
                                    + Create Contact
                                </button>  
        ...
        <script src="theme/js/simple-datatables.min.js" crossorigin="anonymous"></script>
